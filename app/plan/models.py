...
class PartnerPlan(Base):
    ...
    price: Mapped[float] = mapped_column(Numeric(precision=10, scale=2), default=0.00)
    ...
    def __init__(
        ...
        allowed_erp_plans: Optional[Dict] = None,
    ) -> None:
...
class ERPPlan(Base):
    ...
    base_price: Mapped[float] = mapped_column(Numeric(precision=10, scale=2), default=0.00)
